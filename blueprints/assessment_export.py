...
def exportcampaign(id):
    ...
    for testcase in testcases:
        ...
        campaignJson = {}
        for field in ["mitreid", "tactic", "name", "objective", "actions", "tools", "tags", "priorityurgency", "expectedseverity", "expectedincidentcreation", "expectedprevention" ,"expectedalertcreation", "requirements"]:
